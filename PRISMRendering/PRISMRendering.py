...
class PRISMRenderingWidget(slicer.ScriptedLoadableModule.ScriptedLoadableModuleWidget):
  ...
  def modifyDict(self, shader, dictType, value):
    ...
    :param shader: Name of the shader to be modified.
    :type shader: strin
    :param dictType: Name of the dictionnary to be modified.
    :type dictType: string
    :param value: Dictionnary to be added.
    :type value: dict
    """
  ...
  def getText(self):
    ...
    text = qt.QInputDialogging.getText(qt.QMainWindow(), "Duplicate file name","Enter file name:", qt.QLineEdit.Normal, "")
    if text != '':
      return text
  ...
  def onModifyCustomShaderComboIndexChanged(self, value):
    ...
    :param value: Current value of the comboBox. 
    :type value: list
    """
  ...
  def onNewCustomShaderButtonClicked(self):
    ...
    :return: Success at creating the file. 
    :rtype: bool.
    """
  ...
  def duplicateFile(self, old_file_name, new_file_name):
    ...
    :param old_file_name: Name of the file that is being duplicated.
    :type old_file_name: str
    :param new_file_name: Name of the file that is being created.
    :type new_file_name: str
    :return: Duplicated file's path. 
    :rtype: str
    """
  ...
  def setup_file(self, file_, className, displayName):
    ...
    :param className: Name of the class being modified. 
    :type className: str
    :param displayName: Display name of the class being modified. 
